package com.bramerlabs.computational_chemistry.math.vector;

import com.bramerlabs.computational_chemistry.math.matrix.Matrix4f;
...
public class Vector3f {
    ...
    public Vector3f(Color c) {
        this.x = c.getRed() / 255.0f;
        this.y = c.getGreen() / 255.0f;
